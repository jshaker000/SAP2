#!/usr/bin/env ruby
# Renders a human-readable ASCII reference table of the SAP2 instruction
...
out = []
out << "SAP2 instruction set reference -- generated from opcodes.rb, do not edit by hand."
